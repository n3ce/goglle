...
.cheat:hover {
    ...
    body.innerHTML = (`<span id="curPageEl">${getSite(true) ? `Current gamemode: ${getSite(true)}` : 'No game detected'}</span><br><span>(????)</span><br>`);
    ...
    footer.innerHTML = (`<span>GUI by n3ce<br>Cheats by <a style="color: lightblue" href="https://instaram.com/davidias989">n3ce</a></span>`);
    ...
    function toggleHidden(e) {
        e.code == 'KeyM' && (GUI.hidden = !GUI.hidden)
    };
